...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>CRUD | Consultoría CICE</title>
        ...
        <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed  sidebar-inverse">
            ...
            <main id="main-container">
                <div class="content">
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Listado de Menu <small>Consultoría CICE</small></h3>
                ...
                <div class="content">
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">ComboBox <small>Consultoría CICE</small></h3>
                        </div>
                        <div class="block-content block-content-full">
