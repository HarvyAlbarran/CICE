...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Acceso Consultoría CICE</title>
    ...
    <body>
        <div id="page-container" class="main-content-boxed">
            <main id="main-container">
                <div class="bg-image" style="background-image: url('public/assets/img/photos/consultoria.jpg');">
                    <div class="row mx-0 bg-black-op">
                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                <!-- Header -->
                                <div>
                                    <a class="link-effect font-w700 m-4">
                                        <i class="si si-fire"></i>
                                        <span class="font-size-xl text-primary-dark " >Consultoría </span><span class="font-size-xl">CICE</span>                      
                                    </a>
                                    <br>
                                    <h1 class="h5 font-w900 text-muted m-4">Inicio de Sesion</h1>
                                </div>
